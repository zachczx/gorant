...
func Reset() error {
	...
	if err != nil {
		return fmt.Errorf("error dropping table: comments: %v", err)
	}
	_, err = DB.Exec(`DROP TABLE IF EXISTS comments_votes CASCADE;`)
	if err != nil {
		return fmt.Errorf("error dropping table: comments_votes: %v", err)
	}
	_, err = DB.Exec(`DROP TABLE IF EXISTS posts CASCADE;`)
	if err != nil {
		return fmt.Errorf("error dropping table: posts: %v", err)
	}
	_, err = DB.Exec(`DROP TABLE IF EXISTS files CASCADE;`)
	if err != nil {
		return fmt.Errorf("error dropping table: files: %v", err)
	}
	...
	if err != nil {
		return fmt.Errorf("error dropping table: posts_likes: %v", err)
	}

	_, err = DB.Exec(`DROP TABLE IF EXISTS tags CASCADE;`)
	if err != nil {
		return fmt.Errorf("error dropping table: tags: %v", err)
	}

	_, err = DB.Exec(`DROP TABLE IF EXISTS posts_tags CASCADE;`)
	if err != nil {
		return fmt.Errorf("error dropping table: posts_tags: %v", err)
	}

	_, err = DB.Exec(`DROP TABLE IF EXISTS instant_posts CASCADE`)
	if err != nil {
		return fmt.Errorf("error dropping table: instant_posts: %v", err)
	}

	_, err = DB.Exec(`DROP TABLE IF EXISTS instant_comments CASCADE`)
	if err != nil {
		return fmt.Errorf("error dropping table: instant_comments: %v", err)
	}
	...
	if err != nil {
		return fmt.Errorf("error creating table: posts: %v", err)
	}
	...
	if err != nil {
		return fmt.Errorf("error creating table: files: %v", err)
	}
	...
	if err != nil {
		return fmt.Errorf("error creating table: comments: %v", err)
	}
	fmt.Println("Created table: comments")

	_, err = DB.Exec(`CREATE INDEX idx_comments_post_id ON comments (post_id);`)
	if err != nil {
		return fmt.Errorf("error creating index: comments.post_id: %v", err)
	}
	...
	if err != nil {
		return fmt.Errorf("error creating index: comments.ts: %v", err)
	}
	...
	if err != nil {
		return fmt.Errorf("error creating table: posts_likes: %v", err)
	}
	fmt.Println("Created table: posts_likes")

	_, err = DB.Exec(`CREATE INDEX idx_posts_likes_post_id ON posts_likes (post_id);`)
	if err != nil {
		return fmt.Errorf("error creating index: idx_posts_likes_post_id: %v", err)
	}
	...
	if err != nil {
		return fmt.Errorf("error creating table: comments_votes: %v", err)
	}
	...
	if err != nil {
		return fmt.Errorf("error creating index: comments_votes.comment_id: %v", err)
	}
	...
	if err != nil {
		return fmt.Errorf("error creating table: posts_tags: %v", err)
	}
	...
	if err != nil {
		return fmt.Errorf("error creating table: instant_posts: %v", err)
	}
	...
	if err != nil {
		return fmt.Errorf("error creating table: instant_comments: %v", err)
	}
	...
	if err != nil {
		return fmt.Errorf("error creating user: anonymous: %v", err)
	}
